...
귀농귀촌이란.
귀농
귀농어,귀촌 활성화 및 지원에 관한 법률(2015.7.21.시행)
- 농어촌 이외의 지역에 거주하는 농업인이 아닌 사람이 대통령령으로 정하는 농업인이 되기 위한 농촌지역으로 이주한 사람
- 대통령령으로 정하는 기주에 해당하는 사람
- 농어촌지역으로 이주하기 직전에 농어촌 외의 지역에서 1년 이상 주민등록법에 따른 주민등록이 되어 있던 사람이 농업인이 되기 위하여 농촌지역으로 이주한 후 주민등록법에 따른 전입신고를 하고 농어업경경체 육성 및 지원에 관한 법률 제2조제3호에 따른 공업경영체에 등록한 사람.
...
### # 농업의 3가지요소
  ...
  - 노지 : 필드 : 노지농업 : 기후가 안좋으면 문제.
    ...
    - 조생종?, 극조생종? : 조생종은 생육속도가 빠르다. 대신 맛이 별로다.
    - 중생종이 훨씬 맛있다.
...
### # 조수입 / ::> 수량 * 단가.
  - 예를들어 배를 1박스를 수화한다고 하면 단가가 높으면 조수입이 높아진다.
  - 소득 : 조수입 - 경영비 ( 토지임차료, 시설하우스의 감가삼각비. 10년뒤에는 새로지어야함.)
    - 토마토 : 토마토 모종, 토마토 씨앗을 사서 키우든가.
    - 경영비를 낮추면 소득이 올라감.
    - 경영비를 높히면서도 소득이 올리려면.. 면적을늘리면됨.
      - 일할사람이 없어서 토지를 늘려서 일하는게 불가능해짐.
      - 노동력확보고 주요 요인이 될 가능성이 높아짐.
      - 나이
    - 샘플데이터 1만9쳔명 기준
      - 초고령사회 :  하면 65세 20%정도면 
      - 70대 이상 44%
    ...
    - 토마토 배 : 기계회 안됨.
      ...
      - 가지치기 : 전정을하고
      - 꽃이 피면 ::> 자가수분이 안됨.
        - 다를꽃의 꽃가루를 꽃마다 찍어 줘야함.
        - 꽃에 열매가 다 달르면
          - 적화 : 꽃이 7~8개 피는데, 2번~3번이 좋은 배가 나올 가능성이 높음.
            - 적과 : 배는 하나만 남겨놔야함. :> 품질 좋은 배로.
            - 봉지 씨우기 : 해충으로 보호, 농약으로 부터 보호.
...
- 벼 모종은 다 기계가 심음 : 
  - 이앙기로 심고 : 비료 드론으로, 수확은 콤바인으로
  - 벼가 비어있으면 가지를 쳐서 옆을 채워줌.
  - RPC 대형 정미소 : 
  - 사람의 힘 많이 안씀
  - 손가락 농서화됨. ::> 기계화됨.
  - 농기계 임대사업소 : 
...
#### # 귀농,귀촌 정보수집
  - 농촌진흥기관, 농업인 단체, 농촌지도자, 선배귀농,귀촌인을 방문하여 필요한 정보수집
    - 홈페이지(귀농귀촌센터, 농심품부, 농진청, 지자채, 농업기술센터 등 )
    - SNS, 교육기관, 상담 전화 등.
#### # 가족과 충분한 논의
...
### # 핵심이슈
  ...
  - 주요 농산물 도매가격 상승률
  - 스마트팜 혁신밸리 : 밀양? ::>  전북김제시 백구면, 경북상주시 사발면, 경남 밀양시 삼림전용, 전남 고흥군 고흥만 일대.
    - 여성농 :>> 35억 대출.
- 
- 과수 재배 : 3~5년 걸림
...
=====================================================================================
- 쪽파 : 저수지 옆에는 심지 말아. 아침새벽에 안개 독입니다.
...
- 수박 : 작업할게 많음. 7월8월 비오면 물수박.
- 농촌진흥청

#### # 시설 자동화
 - 스마트 온실,스마트 과수원, 스마트 축산, 스마트 노지, 식물농장 등ㅇ
#### # 융복합 및 협업의 시대
 - 아웃소싱, 벤ㄴ치마킹
